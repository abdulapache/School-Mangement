...
<body>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <img src="images/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8" width=48>
      <span class="brand-text font-weight-light"><?php echo $row['t_name']?></span>
    </a>
...
<div class="media-body">
                  <a href="../logout.php">
                   <i class='fa fa-power-off' style='font-size:36px;color: red'></i>
                </a>
              </div>
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="../../admin/dashbord/upload/<?php echo $row['t_pic']?>" alt="User Avatar" height="45">
                        </a>
